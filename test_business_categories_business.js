// Test the new /api/mobile/business-categories/business endpoint
...
async function runTest() {
  try {
    ...
    console.error('='.repeat(60));
    console.log('\n💡 Note: If you see a 404 error, the endpoint may not be deployed yet.');
    console.log('   The endpoint has been added to the code and will work after deployment.');
  }
}
