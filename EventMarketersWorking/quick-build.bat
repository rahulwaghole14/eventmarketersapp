@echo off
echo Quick APK Build - Bypassing CMake issues...
...
echo Step 4: Build APK with timeout protection...
cd android
timeout /t 300 /nobreak > nul & call gradlew assembleDebug --no-daemon --max-workers=1 --parallel=false
...
if exist "app\build\outputs\apk\debug\app-debug.apk" (
    ...
    echo ========================================
    echo The build may have failed or timed out.
