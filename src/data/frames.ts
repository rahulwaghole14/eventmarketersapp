...
export const FRAME_LAYOUTS: FrameLayouts = {
  ...
  aspect_frame1: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 440, y: 455, color: '#1a1814ff' },
    { key: 'email', x: 20, y: 455 },
    { key: 'website', x: 450, y: 470, color: '#1a1814ff' },
    { key: 'address', x: 20, y: 470, color: '#1a1814ff' },
    { key: 'category', x: 200, y: 470, color: '#1a1814ff' },
    { key: 'logo', x: 599, y: 8 },
  ],
  aspect_frame2: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 50, y: 435 },
    { key: 'email', x: 250, y: 435 },
    { key: 'website', x: 490, y: 460 },
    { key: 'address', x: 50, y: 460 },
    { key: 'category', x: 250, y: 460 },
    { key: 'logo', x: 290, y: 350, circular: true, size: { width: 50, height: 50 } },
  ],
  aspect_frame3: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 490, y: 445, color: '#1a1814ff' },
    { key: 'email', x: 50, y: 445 },
    { key: 'website', x: 490, y: 460 },
    { key: 'address', x: 50, y: 460 },
    { key: 'category', x: 250, y: 460 },
    { key: 'logo', x: 599, y: 8 },
  ...
  aspect_frame4: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 150, y: 432, color: '#077ca7ff' },
    { key: 'email', x: 150, y: 451, color: '#077ca7ff' },
    { key: 'website', x: 456, y: 432 },
    { key: 'address', x: 447, y: 456 },
    { key: 'category', x: 253, y: 465 },
    { key: 'logo', x: 20, y: 420, circular: true },
  ],
  aspect_frame5: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 530, y: 445 },
    { key: 'email', x: 140, y: 450 },
    { key: 'website', x: 500, y: 465 },
    { key: 'address', x: 330, y: 465 },
    { key: 'category', x: 130, y: 465 },
    { key: 'logo', x: 20, y: 420, size: { width: 40, height: 40 } },
  ],
  aspect_frame6: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 200, y: 460, color: '#1a1814ff' },
    { key: 'email', x: 200, y: 440, color: '#1a1814ff' },
    { key: 'website', x: 450, y: 430, color: '#1a1814ff' },
    { key: 'address', x: 450, y: 450, color: '#1a1814ff' },
    { key: 'category', x: 200, y: 420, color: '#1a1814ff' },
    { key: 'logo', x: 29, y: 407, circular: true, size: { width: 50, height: 50 } },
  ],
  aspect_frame7: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 500, y: 433, color: '#2c0404ff' },
    { key: 'email', x: 450, y: 455 },
    { key: 'website', x: 450, y: 410 },
    { key: 'address', x: 150, y: 450 },
    { key: 'category', x: 150, y: 420 },
    { key: 'logo', x: 20, y: 410, size: { width: 45, height: 45 } },
  ],
  aspect_frame8: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 100, y: 430 },
    { key: 'email', x: 400, y: 430 },
    { key: 'website', x: 50, y: 450 },
    { key: 'address', x: 250, y: 450 },
    { key: 'category', x: 450, y: 450 },
    { key: 'logo', x: 310, y: 375, circular: true, size: { width: 40, height: 40 } },
  ],
  aspect_frame9: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 180, y: 440 },
    { key: 'email', x: 380, y: 440 },
    { key: 'website', x: 450, y: 460 },
    { key: 'address', x: 30, y: 460 },
    { key: 'category', x: 200, y: 460 },
    { key: 'logo', x: 40, y: 400, circular: true, size: { width: 45, height: 45 } },
  ],
  aspect_frame10: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 50, y: 440 },
    { key: 'email', x: 350, y: 445 },
    { key: 'website', x: 450, y: 460, color: '#2c0404ff' },
    { key: 'address', x: 50, y: 460, color: '#2c0404ff' },
    { key: 'category', x: 210, y: 460, color: '#2c0404ff' },
    { key: 'logo', x: 599, y: 8 },
  ],
  aspect_frame11: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 148, y: 433, color: '#080707ff' },
    { key: 'email', x: 20, y: 465 },
    { key: 'website', x: 300, y: 465, color: 'white' },
    { key: 'address', x: 400, y: 442 },
    { key: 'category', x: 520, y: 465 },
    { key: 'logo', x: 599, y: 8 },
  ],
  aspect_frame12: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 80, y: 430, color: '#2c0404ff' },
    { key: 'email', x: 370, y: 440 },
    { key: 'website', x: 482, y: 460, color: 'white' },
    { key: 'address', x: 5, y: 460 },
    { key: 'category', x: 220, y: 460 },
    { key: 'logo', x: 599, y: 8 },
  ],
  aspect_frame13: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 280, y: 405 },
    { key: 'email', x: 150, y: 435 },
    { key: 'website', x: 430, y: 455 },
    { key: 'address', x: 140, y: 455 },
    { key: 'category', x: 440, y: 435 },
    { key: 'logo', x: 599, y: 8 },
  ],
  aspect_frame14: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 50, y: 435 },
    { key: 'email', x: 400, y: 440 },
    { key: 'website', x: 484, y: 460, color: '#2c0404ff' },
    { key: 'address', x: 50, y: 460, color: '#2c0404ff' },
    { key: 'category', x: 230, y: 460, color: '#2c0404ff' },
    { key: 'logo', x: 599, y: 8 },
  ],
  aspect_frame15: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 16, y: 436, color: '#2c0404ff' },
    { key: 'email', x: 400, y: 436, color: '#2c0404ff' },
    { key: 'website', x: 484, y: 465, color: '#2c0404ff' },
    { key: 'address', x: 16, y: 465, color: '#2c0404ff' },
    { key: 'category', x: 230, y: 465, color: '#2c0404ff' },
    { key: 'logo', x: 599, y: 8 },
  ],
  // 3:2 aspect ratio frame layouts
  ratio_3_2_frame1: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 460, y: 420, color: '#1a1814ff' },
    { key: 'email', x: 20, y: 420 },
    { key: 'website', x: 450, y: 460, color: '#1a1814ff' },
    { key: 'address', x: 20, y: 460, color: '#1a1814ff' },
    { key: 'category', x: 200, y: 460, color: '#1a1814ff' },
    { key: 'logo', x: 599, y: 8 },
  ],
  ratio_3_2_frame2: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 490, y: 390, color: '#1a1814ff' },
    { key: 'email', x: 100, y: 390 },
    { key: 'website', x: 490, y: 440 },
    { key: 'address', x: 50, y: 440 },
    { key: 'category', x: 250, y: 440 },
    { key: 'logo', x: 599, y: 8 },
  ],
  ratio_3_2_frame3: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 20, y: 410, color: '#1a1814ff' },
    { key: 'email', x: 350, y: 410 },
    { key: 'website', x: 490, y: 440, color: '#1a1814ff' },
    { key: 'address', x: 50, y: 440, color: '#1a1814ff' },
    { key: 'category', x: 250, y: 440, color: '#1a1814ff' },
    { key: 'logo', x: 599, y: 8 },
  ],
  ratio_3_2_frame4: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 100, y: 370 },
    { key: 'email', x: 350, y: 370 },
    { key: 'website', x: 400, y: 430, color: '#2c0404ff' },
    { key: 'address', x: 250, y: 430, color: '#2c0404ff' },
    { key: 'category', x: 50, y: 430, color: '#2c0404ff' },
    { key: 'logo', x: 599, y: 8 },
  ],
  ratio_3_2_frame5: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 50, y: 370, color: '#2c0404ff' },
    { key: 'email', x: 370, y: 373, color: '#2c0404ff' },
    { key: 'website', x: 500, y: 440, color: '#2c0404ff' },
    { key: 'address', x: 300, y: 440, color: '#2c0404ff' },
    { key: 'category', x: 100, y: 440, color: '#2c0404ff' },
    { key: 'logo', x: 599, y: 8, size: { width: 40, height: 40 } },
  ],
  // 16:9 aspect ratio frame layouts (matches 3:2 layout coordinates)
  ratio_16_9_frame1: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 460, y: 420, color: '#1a1814ff' },
    { key: 'email', x: 20, y: 420 },
  ...
  ratio_16_9_frame3: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
    { key: 'phone', x: 20, y: 390, color: '#1a1814ff' },
    { key: 'email', x: 350, y: 390 },
    { key: 'website', x: 490, y: 430, color: '#1a1814ff' },
    { key: 'address', x: 50, y: 430, color: '#1a1814ff' },
    { key: 'category', x: 250, y: 430, color: '#1a1814ff' },
    { key: 'logo', x: 599, y: 8 },
  ],
  ratio_16_9_frame4: [
    { key: 'companyName', x: 20, y: 8, color: 'gray' },
...
// Aspect ratio specific frame assets mapping (from assets/frames/aspect-ratio-frames)
export const ASPECT_RATIO_FRAME_ASSETS: FrameAssets = {
  aspect_frame1: require('../assets/frames/aspect-ratio-frames/f1.png'),
  aspect_frame2: require('../assets/frames/aspect-ratio-frames/f2.png'),
  aspect_frame3: require('../assets/frames/aspect-ratio-frames/f3.png'),
  aspect_frame4: require('../assets/frames/aspect-ratio-frames/f4.png'),
  aspect_frame5: require('../assets/frames/aspect-ratio-frames/f5.png'),
  aspect_frame6: require('../assets/frames/aspect-ratio-frames/f6.png'),
  aspect_frame7: require('../assets/frames/aspect-ratio-frames/f7.png'),
  aspect_frame8: require('../assets/frames/aspect-ratio-frames/f8.png'),
  aspect_frame9: require('../assets/frames/aspect-ratio-frames/f9.png'),
  aspect_frame10: require('../assets/frames/aspect-ratio-frames/f10.png'),
  aspect_frame11: require('../assets/frames/aspect-ratio-frames/f11.png'),
  aspect_frame12: require('../assets/frames/aspect-ratio-frames/f12.png'),
  aspect_frame13: require('../assets/frames/aspect-ratio-frames/f13.png'),
  aspect_frame14: require('../assets/frames/aspect-ratio-frames/f14.png'),
  aspect_frame15: require('../assets/frames/aspect-ratio-frames/f15.png'),
};

export const RATIO_3_2_FRAME_ASSETS: FrameAssets = {
  ratio_3_2_frame1: require('../assets/frames/aspect-ratio-frames/ratio_3_2/f1.png'),
  ratio_3_2_frame2: require('../assets/frames/aspect-ratio-frames/ratio_3_2/f2.png'),
  ratio_3_2_frame3: require('../assets/frames/aspect-ratio-frames/ratio_3_2/f3.png'),
  ratio_3_2_frame4: require('../assets/frames/aspect-ratio-frames/ratio_3_2/f4.png'),
  ratio_3_2_frame5: require('../assets/frames/aspect-ratio-frames/ratio_3_2/f5.png'),
};

export const RATIO_16_9_FRAME_ASSETS: FrameAssets = {
  ratio_16_9_frame1: require('../assets/frames/aspect-ratio-frames/ratio_16_9/f1.png'),
  ratio_16_9_frame2: require('../assets/frames/aspect-ratio-frames/ratio_16_9/f2.png'),
  ratio_16_9_frame3: require('../assets/frames/aspect-ratio-frames/ratio_16_9/f3.png'),
  ratio_16_9_frame4: require('../assets/frames/aspect-ratio-frames/ratio_16_9/f4.png'),
  ratio_16_9_frame5: require('../assets/frames/aspect-ratio-frames/ratio_16_9/f5.png'),
};

// Frame image assets mapping
export const FRAME_ASSETS: FrameAssets = {
  ...ASPECT_RATIO_FRAME_ASSETS,
  ...RATIO_3_2_FRAME_ASSETS,
  ...RATIO_16_9_FRAME_ASSETS,
