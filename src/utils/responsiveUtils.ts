...
export const responsiveGrid = {
  // Column counts based on screen size
  ...
  // Item widths
  itemWidth: (screenWidth - (responsiveLayout.containerPaddingHorizontal * 2) - (Math.max(12, screenWidth * 0.03) * (isTablet ? (isLandscape ? 3 : 2) : (isLandscape ? 2 : 1)))) / (isTablet ? (isLandscape ? 4 : 3) : (isLandscape ? 3 : 2)),
};
