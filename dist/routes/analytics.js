...
router.get('/dashboard', async (req, res) => {
    try {
        ...
        const [totalUsers, totalCustomers, totalImages, totalVideos, totalImageDownloads, totalVideoDownloads, activeSubscriptions, pendingImages, pendingVideos] = await Promise.all([
